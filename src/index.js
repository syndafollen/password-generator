...
async function deletePassword(id) {
  // ??? где взять айди
  // https://j7rrbn.deta.dev/delete/:id endpoint
  // METHOD "DELETE"
  // нажимаю кнопку
  // отправляем запрос с айди элемента
  // если reposponse.status === 200, то удалено
  // убрать из разметки ??? запросить новые пароли
  // отрисовать новые пароли
